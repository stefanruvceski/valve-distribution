...
<xsl:template match="/">
	<html>
      ...
      <form>
        <input TYPE="button" VALUE=" Contents " ONCLICK="location = 'wh_toc.xml';" NAME="Help Topics" />&#160;
        <input TYPE="button" VALUE="   Index   " ONCLICK="location = 'wh_index.xml';" NAME="Index" /><br /><br />
