...
<xsl:output method="html" encoding="windows-1251" media-type="text/html"/>
<xsl:template match="/">
	<html>
		<HEAD>
			<TITLE></TITLE>
      ...
      <form>
        <input TYPE="button" VALUE=" Содержание " ONCLICK="location = 'wh_toc.xml';" NAME="Help Topics" />&#160;
        <input TYPE="button" VALUE="   Указатель   " ONCLICK="location = 'wh_index.xml';" NAME="Index" /><br /><br />
